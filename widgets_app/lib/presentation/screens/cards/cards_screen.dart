...
class _CardsView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // SingleChildScrollView: unico hijo y es un scroll
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Align(alignment: Alignment.bottomLeft, child: Text('$label - ouline')),
          ],
        ),
      ),
    );
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colors = Theme.of(context).colorScheme;
    return Card(
      // Clip.hardEdge: evita que sus hijos se salgan de su borde
